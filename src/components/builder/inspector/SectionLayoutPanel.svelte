<script lang="ts">
  ...
  const presetsBySectionType: Record<string, Array<{ id: string; label: string; desc: string }>> = {
    ...
    hero: [
      ...
      { id: 'hero_video_mockup', label: 'Video Mockup', desc: 'Teks tengah + bingkai mockup 16:9 bayangan tebal' },
    ...
    testimonials: [
      ...
      { id: 'video_story_testimonials', label: 'Video Story 9:16', desc: '4 Kartu vertikal gaya story/TikTok' },
