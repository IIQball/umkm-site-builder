...
>
  ...
  >
    ...
    >
      <p
        style="color: var(--theme-text-primary, var(--color-text-main)); line-height: 1.6;"
      >
        {tagline}
      </p>
      {#if whatsappNumber}
    ...
    >
      <a
        href="#products"
        style="color: var(--theme-text-primary, var(--color-text-main)); font-family: var(--theme-font-body, var(--font-family, inherit)); font-size: var(--theme-text-body, var(--text-body-size, 14px));"
  ...
  <div
    ...
    tabindex="0"
  >
    <span class="cq-wordmark-text font-black font-sans text-[var(--color-border)] uppercase tracking-tighter block truncate transition-colors hover:text-[var(--theme-primary, var(--color-primary))]/30">
      {brandName}
    </span>
    <p
