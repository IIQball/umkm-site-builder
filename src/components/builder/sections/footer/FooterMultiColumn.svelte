...
<div class="cq-footer-grid-3 text-left pb-8 border-b border-[var(--color-border)]">
  <!-- Kolom 1: Profil Toko -->
  <div
  ...
  >
    <div class="flex items-center gap-2.5">
      ...
      {:else}
        <div class="w-8 h-8 rounded-[var(--theme-btn-radius,var(--btn-radius,12px))] bg-[var(--theme-primary, var(--color-primary))] text-[var(--theme-btn-primary-text, white)] flex items-center justify-center font-[var(--theme-font-heading,var(--font-heading,inherit))] font-bold text-xs shadow-xs">
  ...
  >
    <h4
      style="font-family: var(--theme-font-heading, var(--font-heading, inherit)); font-size: var(--theme-text-caption, var(--text-caption-size, 12px)); font-weight: 700; letter-spacing: 0.05em; text-transform: uppercase; color: var(--theme-text-primary, var(--color-text-main));"
    >
      Kontak & Lokasi
    </h4>
    <ul
...
<!-- Bottom Bar -->
<div
  class="cq-footer-bottom-bar pt-6 rounded-2xl p-2 transition-all cursor-pointer {activeNodeId === 'footer_copyright' ? 'ring-2 ring-[var(--theme-primary, var(--color-primary))] ring-offset-2 dark:ring-offset-slate-900' : ''}"
