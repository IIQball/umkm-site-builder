...
<div class="py-12 text-center max-w-2xl mx-auto space-y-6">
  <HeroHeaderContent
    {badgeText}
    {tagName}
    {title}
  ...
  >
    ...
    <div class="bg-emerald-600 text-white p-3 rounded-xl rounded-tr-xs shadow-xs text-xs ml-auto max-w-[85%] font-sans">
