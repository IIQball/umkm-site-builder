...
<div class="w-full flex justify-center">
  ...
  >
    <div>
      ...
      <p
        class="text-[var(--theme-text-muted, var(--color-text-muted))] font-[var(--theme-font-body,var(--font-family,inherit))] mt-0.5 leading-relaxed"
    ...
    <div
      ...
      class={`w-full h-48 rounded-xl overflow-hidden border border-[var(--color-border)] bg-[var(--theme-surface, var(--color-card-base))] transition-all outline-none ${
    ...
    <a
      ...
      class={`inline-flex items-center justify-center gap-2 w-full h-9 rounded-[var(--theme-btn-radius,var(--btn-radius,16px))] bg-[var(--theme-btn-primary-bg,var(--btn-primary-bg,var(--theme-primary, var(--color-primary))))] text-[var(--theme-btn-primary-text, var(--btn-primary-text, white))] font-[var(--theme-font-heading,var(--font-heading,inherit))] font-bold hover:opacity-90 active:scale-[0.98] shadow-sm transition-all outline-none ${
