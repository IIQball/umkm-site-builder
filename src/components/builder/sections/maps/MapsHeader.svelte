...
>
  {#if badge}
    <div
      class={`inline-flex items-center gap-1.5 px-3 py-1 rounded-full bg-[var(--theme-primary, var(--color-primary))]/10 text-[var(--theme-primary, var(--color-primary))] font-[var(--theme-font-heading,var(--font-heading,inherit))] font-semibold mb-2 ${align === 'center' ? 'mx-auto' : ''}`}
  ...
  <h2
    class="font-[var(--theme-font-heading,var(--font-heading,inherit))] text-[var(--theme-text-primary, var(--color-text-main))] tracking-tight leading-tight"
  ...
  {#if subtitle}
    <p
      class="text-[var(--theme-text-muted, var(--color-text-muted))] font-[var(--theme-font-body,var(--font-family,inherit))] mt-1.5 max-w-2xl leading-relaxed {align === 'center' ? 'mx-auto' : ''}"
