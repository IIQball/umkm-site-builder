...
<div class="cq-map-split text-left">
  ...
  >
    <div class="space-y-3">
      ...
      <div class="space-y-2.5 text-[var(--theme-text-muted, var(--color-text-muted))] font-[var(--theme-font-body,var(--font-family,inherit))]">
        {#if directionsLandmark}
          <div class="p-3 bg-[var(--color-nested-base)] rounded-xl border border-[var(--color-border)] space-y-1">
            <div
              class="flex items-center gap-1.5 font-[var(--theme-font-heading,var(--font-heading,inherit))] font-bold text-[var(--theme-text-primary, var(--color-text-main))]"
            ...
            <p
              class="leading-relaxed pl-5 text-[var(--theme-text-muted, var(--color-text-muted))] font-[var(--theme-font-body,var(--font-family,inherit))]"
              style="font-size: var(--theme-text-body, var(--text-body-size, 14px));"
            >
              {directionsLandmark}
            </p>
    ...
    <a
      ...
      class={`inline-flex items-center justify-center gap-2 w-full h-9 px-4 rounded-[var(--theme-btn-radius,var(--btn-radius,16px))] bg-[var(--theme-btn-primary-bg,var(--btn-primary-bg,var(--theme-primary, var(--color-primary))))] text-[var(--theme-btn-primary-text, var(--btn-primary-text, white))] font-[var(--theme-font-heading,var(--font-heading,inherit))] font-bold hover:opacity-90 active:scale-[0.98] shadow-sm transition-all outline-none ${
