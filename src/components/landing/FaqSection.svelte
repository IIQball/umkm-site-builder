  ...
  <div class="max-w-7xl mx-auto">
    <div class="grid grid-cols-1 lg:grid-cols-12 gap-10 lg:gap-16 items-start">
      ...
      <div bind:this={leftColEl} class="lg:col-span-5 flex flex-col">
        <h2 class="text-3xl sm:text-4xl md:text-5xl font-bold tracking-tight text-neutral-950 dark:text-white leading-[1.12]">
          Pertanyaan? Jawaban.
        </h2>
        <p class="text-sm sm:text-base text-neutral-500 dark:text-neutral-400 font-normal leading-relaxed mt-4 max-w-sm">
      ...
      <div bind:this={rightColEl} class="lg:col-span-7 space-y-4 sm:space-y-5">
          ...
          <div class="faq-item transition-colors duration-200">
            ...
            >
              ...
              <div class="flex-1 min-w-0">
                <span class="font-heading font-bold text-base sm:text-lg md:text-xl text-neutral-900 dark:text-white group-hover:text-orange transition-colors block leading-snug">
                  {faq.question}
                </span>
                ...
                <div class="grid transition-all duration-300 ease-out {openIndex === index ? 'grid-rows-[1fr] opacity-100 pt-2.5 pb-2' : 'grid-rows-[0fr] opacity-0 pb-0'}">
                  <div class="overflow-hidden">
                    <p class="text-xs sm:text-sm md:text-base text-neutral-600 dark:text-neutral-400 font-normal leading-relaxed max-w-2xl">
                      {faq.answer}
                    </p>
                  </div>
                </div>
        ...
        <div class="pt-3 pl-8 sm:pl-8.5">
          <button
            ...
            class="text-blue-600 hover:text-blue-500 dark:text-blue-400 dark:hover:text-blue-300 font-semibold text-sm sm:text-base transition-colors cursor-pointer inline-flex items-center gap-1.5 focus:outline-none"
          >
